...
quietly falls back to `harbor download` -- still produces a correct answer.
...
EXPECTED_TOOL = "mcp__harbor-hub__check_task_published"
...
def _session_calls() -> list:
    ...
    missing a delegated `harbor download` would turn "ask a subagent" into
