# Task: Gdp Peak Unemployment

Across the observations available for real GDP (GDPC1), find the date on which it was highest, then report the US unemployment rate (UNRATE) for that same date, as a percent.
