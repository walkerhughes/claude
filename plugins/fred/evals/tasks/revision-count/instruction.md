...
Across the observations available for real GDP (GDPC1), count how many have been revised since they were first published, that is, how many now hold a different value than the one first reported.
