...
For the CPI series CPIAUCSL, find the most recent year-over-year change, as a percent. The server can compute that transformation for you; do not do the arithmetic by hand.
